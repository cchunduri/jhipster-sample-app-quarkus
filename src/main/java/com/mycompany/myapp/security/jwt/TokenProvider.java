...
public class TokenProvider {
    ...
    private void init() throws Exception {
        ...
        this.tokenValidityInMilliseconds = this.jHipsterProperties.security.authentication.jwt.tokenValidityInSeconds * 1000;
        this.tokenValidityInMillisecondsForRememberMe = this.jHipsterProperties.security.authentication.jwt.tokenValidityInSecondsForRememberMe * 1000;
    }
